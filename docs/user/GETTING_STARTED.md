# Getting Started with Hagelschutz VKF

This guide will help you install and set up the Hagelschutz VKF custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/joe-akeem/ha-hagelschutz-vkf`
6. Set category to "Integration"
7. Click "Add"
8. Find "Hagelschutz VKF" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/joe-akeem/ha-hagelschutz-vkf/releases)
2. Extract the `hagelschutz_vkf` folder from the archive
3. Copy it to `custom_components/hagelschutz_vkf/` in your Home Assistant configuration directory
...
4. Select entities from "Hagelschutz VKF"
...
- Report issues at [GitHub Issues](https://github.com/joe-akeem/ha-hagelschutz-vkf/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/joe-akeem/ha-hagelschutz-vkf/discussions)
